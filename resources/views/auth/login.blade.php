            ...
            <div class="font-heading text-3xl font-bold tracking-tight text-white flex items-center justify-center gap-3">
                <span class="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-[0_2px_10px_rgba(245,158,11,0.3)]">
                    <svg viewBox="0 0 100 100" class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none">
                        <defs><linearGradient id="coinvestLgLogin" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FDE047"/><stop offset="1" stop-color="#F59E0B"/></linearGradient></defs>
                        <circle cx="50" cy="50" r="34" stroke="url(#coinvestLgLogin)" stroke-width="14" stroke-linecap="round" stroke-dasharray="168.5 45.1" transform="rotate(38 50 50)"/>
                        <path d="M38 60 L62 40 M62 40 L52 40 M62 40 L62 50" stroke="url(#coinvestLgLogin)" stroke-width="9" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </span>
                Coinvest
            </div>
